            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                {[
                  ...
                  <div 
                    key={index}
                    className="organic-card organic-card-3d flex items-start gap-5 p-6 group"
                  >
                    <div className="organic-icon-wrapper icon-rotate-hover w-14 h-14 flex-shrink-0">
            ...
            <Card className="organic-card overflow-hidden">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="h-12 rounded-xl input-enhanced border-2 border-border/50 focus:border-accent/50"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-12 text-base font-semibold rounded-full bg-gradient-to-r from-accent to-accent/85 text-white hover:shadow-lg transition-all btn-pulse"
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <AnimatedSection key={index} animation="scale-in" delay={index * 100}>
                  <div className="organic-card organic-card-3d flex flex-col items-center gap-4 p-8">
